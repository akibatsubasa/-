...
\begin{figure}[h]
    \begin{screen}
    \begin{center}
        \includegraphics[scale=0.1, clip]{./img/basicMIDI.png}
...
\begin{figure}[h]
    \begin{screen}
    \begin{center}
        \includegraphics[scale=0.５, clip]{./img/lookbackMIDI.png}
...
\begin{figure}[h]
    \begin{screen}
    \begin{center}
        \includegraphics[scale=0.５, clip]{./img/attentionMIDI.png}
