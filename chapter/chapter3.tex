...
\begin{figure}[!ht]
    ...
    \begin{center}
        ...
        \caption{basic\_rnnのモデル(２)}
        \label{fig:basic\_rnnのモデル(２)}
    \end{center}
    \end{screen}
<<<<<<< HEAD
\end{figure} \\
